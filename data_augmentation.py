...
class DataAugmentation:
    ...
    def morphological_alteration(self, img):
        ...
        if random.randint(1, 5) == 1:
            ...
            img = cv2.erode(img, self.kernel, iterations=random.randint(1, 2))
    ...
    def transform_image():
        transform = alb.Compose([
            alb.OneOf([
                ...
                alb.OneOf([
                    alb.PixelDropout(dropout_prob=0.5, drop_value=255, p=1),
...
data = DataAugmentation().process_data()
